...
class Draw{
    constructor(context, GameBoard) {
        ...
        this.board.src = "https://raw.githubusercontent.com/projectsandmore/ChessGame/master/gameImages/board.png";
    ...
    loadPiecies(piecies){
        ...
        for(var type=0; type<types.length; type++) {
            for (let piece in piecies) {
                ...
                imgpics.src = "https://raw.githubusercontent.com/projectsandmore/ChessGame/master/gameImages/" + piecname + ".png"
                data.push(imgpics);
            }
        }
        return(data);
